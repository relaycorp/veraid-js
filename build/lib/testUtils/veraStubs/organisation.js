...
export const VERAID_RECORD = new DnsRecord(ORG_VERAID_DOMAIN, 'TXT', DnsClass.IN, RECORD_TTL, await generateTxtRdata(ORG_KEY_PAIR.publicKey, VERAID_RECORD_TTL_OVERRIDE));
export const ORG_KEY_SPEC = {
    keyAlgorithm: KeyAlgorithmType.RSA_2048,
    keyId: calculateDigest('sha256', await derSerializePublicKey(ORG_KEY_PAIR.publicKey)).toString('base64'),
};
