...
This is the Node.js implementation of [VeraId](https://veraid.net), an offline authentication p**ros**tocol powered by DNSSEC. This library implements all the building blocks that signature producers and consumers need.
